...
{
    internal static class FakeUserDtoGenerator
    {
        private static readonly Faker<UserDto> _faker;

        static FakeUserDtoGenerator()
        {
        ...
        internal static UserDto Generate()
        {
            return _faker.Generate();
        }

        internal static UserDto GenerateWithModel(UserModel model)
        {
