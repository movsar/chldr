...
namespace chldr_ui.ViewModels
{
    public class WordDetailsEditViewModel : ViewModelBase
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            EntryDto.Details = SerializeWordDetails((WordType)EntryDto.Subtype);

            //if (EntryDto.Subtype != 0)
            //{
        ...
        protected override async Task OnParametersSetAsync()
        {
            ...
            {
                var repos = DataProvider.Repositories();
                ParentEntry = await repos.Entries.GetAsync(EntryDto.ParentEntryId);
            }
        ...
        private void DeserializeWordDetails()
        {
            ...
            var details = WordHelper.DeserializeWordDetails((WordType)EntryDto.Subtype, EntryDto.Details);
            switch (details)
            {
