...
namespace chldr_data.Repositories
{
    ...
    {
        public RealmSourcesRepository(Realm context, ExceptionHandler exceptionHandler, FileService fileService, string userId) : base(context, exceptionHandler, fileService, userId) { }
